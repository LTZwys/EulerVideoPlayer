...
class SetupMainWindow:
    ...
    add_left_menus = [
        ...
        {
            "btn_icon" : "icon_video.svg",
            "btn_id" : "btn_video",
            "btn_text" : "video player",
            "btn_tooltip" : "video player",
            "show_top" : True,
            "is_active" : False
        },
        {
    ...
    def setup_gui(self):
        ...
        # PROBLEM
        # self.ui.left_column.menus.videoItem_list.set_stylesheet(
        #     radius=10,
        #     color=self.themes['app_color']['text_foreground'],
        #     bg_color=self.themes['app_color']['dark_one'],
        #     item_bg_color=self.themes['app_color']['dark_two'],
        #     item_bg_hover_color=self.themes['app_color']['bg_three'],
        #     item_bg_selected_color=self.themes['app_color']['context_color'],
        #     border_color=self.themes['app_color']['dark_two'],
        #     scroll_bar_bg_color=self.themes['app_color']['dark_three'],
        #     scroll_bar_btn_color=self.themes['app_color']['context_hover'],
        #     context_color=self.themes["app_color"]["context_color"]
        # )

        # self.ui.left_column.menus.videoItem_list.add_video_item(None,"Test","test","1","1:00")
        # PAGES
        # ///////////////////////////////////////////////////////////////
